...
export const translations = {
    [Language.EN]: {
        ...
        MUSIC_CONFIG_APPLIED: "Music config applied.",
        SETTINGS_PERSIST_FAILED: "Settings could not be saved.",
    ...
    [Language.CN]: {
        ...
        TYPE_PLAYLIST: "歌单",
        APPLY_SETTINGS: "应用配置",
        MUSIC_CONFIG_APPLIED: "在线音乐配置已应用。",
        SETTINGS_PERSIST_FAILED: "设置未能保存。",
