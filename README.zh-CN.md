...
- [国际化支持](#国际化支持-i18n)
- [主题系统](#主题系统-theme-system)
- [开发建议](#开发建议-development-tips)
- [脚本命令](#脚本命令-scripts)
- [贡献](#贡献-contributing)
- [许可证](#许可证-license)
- [鸣谢](#鸣谢-acknowledgments)
...
- **双模式播放**：
  ...
  - **在线模式**：集成 MetingAPI，支持网易云音乐 / QQ 音乐等平台的歌单解析
...
- **在线音乐**：实现 API 过滤，在 PWA 环境下也能播放在线音乐
...
项目支持中英双语，所有 UI 文本均通过 `src/utils/i18n.ts` 管理，包括：
